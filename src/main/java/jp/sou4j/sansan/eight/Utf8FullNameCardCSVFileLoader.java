...
/**
 * <p>EightからダウンロードできるCSV形式の名刺データファイル(フルネームUTF-8版)を読み込むためのクラスです。</p>
 * @author OSCA
 */
public class Utf8FullNameCardCSVFileLoader extends CardCSVFileLoader {
	 ...
	 */
	public Utf8FullNameCardCSVFileLoader(File file) {
